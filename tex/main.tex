...
\usepackage{tikz, fontspec, xcolor, geometry, pgffor, intcalc, atbegshi, afterpage, rotating, pdfpages, eso-pic, etoolbox}
\geometry{
  paperwidth=303mm,
  paperheight=426mm,
  margin=0mm
...
\NewDocumentCommand{\IfNumberInListTF}{mmmm}
  {
    ...
    % Build a proper clist from the (possibly macro/braced) input
...
\newpage
\CoverBackground
\includepdf[pages=1,pagecommand={\thispagestyle{empty}}]{Outro.pdf}
\ClearShipoutPictureBG
