...
\usepackage{tikz, fontspec, xcolor, geometry, pgffor, intcalc, atbegshi, afterpage, rotating, pdfpages, eso-pic}
\geometry{
  paperwidth=303mm,
  paperheight=426mm,
  margin=0mm
...
\newcommand{\SeptemberHolidays}{33}
...
% 1: Number of days of current month
\newcommand{\colorOutOfMonthDays}[1]{
    \setcounter{DayIndex}{0}
    ...
    \ifnum \arabic{FirstDayNumber} < \calculateValue{\arabic{NumberOfDaysOfLastMonth} + 1}
	    ...
	    \colorCell{InactiveDayNumberColor!10}
